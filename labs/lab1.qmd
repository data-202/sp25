...
-   Locate a data sets in the `critstats` package or use `gss` data or your own data set.
...
-   Develop an original research question on two variables in your selected data set.
