...
### Framing statistical learning in a justice inquiry

Statistical learning, when informed by intersectional theory, for example, offers a difficult opportunity to examine how we approach framing and analyzing issues of social injustice. By attempting to model the complex interplay of multiple social identities and contextual factors, researchers can more accurately identify our own biases and inequities that inform how we study and advocate for policies aimed at achieving equity and justice for all.
...
| Gender | Achieving gender equality and empowerment | Addressing discrimination based on sexuality or gender expression | Ensuring equal rights for all genders |
